...
const api = {
  ...
  activateUser: (payload: { userId: string }) => ipcRenderer.invoke('admin:activate-user', payload),
  deactivateUser: (payload: { userId: string }) => ipcRenderer.invoke('admin:deactivate-user', payload),
